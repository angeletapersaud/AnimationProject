    ...
    <div id="AboutPg">
     ...
     <div className="AboutUsContainer">
        <div className="card">
          ...
          <h2>Who We Are</h2>
          <p>This website was created for those who have an interest in animation.</p>
          </div>
        </div>
        <div className="card">
          <div className="imgBx">
          ...
          <div className="content">
          <h2>Search Films</h2>
          <p> Whether you need a little refresher regarding a specific animation, or if you are in need of full details you have come to the right place. You will get access to any information that you may need for free.  </p>
          </div>
        </div>
        <div className="card">
          <div className="imgBx">
          ...
          <p> We encourage you to sign up for alerts! Be the first to know of any animation updates from our site.</p>
          </div>
        </div>
      </div>
    </div>
